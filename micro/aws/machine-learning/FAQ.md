...
* __Confusion Matrix__
  ...
  | __Actual False__ | I was wrong. (False Positive) (Type I error) | I predicted Correctly! (True Negative)| FPR=FP/(FP/TN) |
  | |Precision = TP/(TP+FP) | TNR=TN/(TN+FP) | Accuracy = (TP + TN)/(TP+FP+FN+TN) |

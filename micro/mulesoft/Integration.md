...
* A **message** actually contains two parts, a **header** and a **body**. The header contains meta-information about the messageâ€”who sent it, where itâ€™s going, etc.; The body contains the data being transmitted and is ignored by the messaging system.
